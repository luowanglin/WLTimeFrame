#
#  Be sure to run `pod spec lint WLTimeFrameView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "luowanglin"
  # s.authors            = { "luowanglin" => "luowanglin@icloud.com" }
  # s.social_media_url   = "http://twitter.com/luowanglin"
